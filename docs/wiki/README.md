...
- 想直接询问项目能力、流程、故障或代码归属时，先读 [项目知识图谱](./knowledge-graph/README.md)。
- 第一次系统理解整个项目时，再读 [项目总手册](./project-handbook.md)。
...
- [项目知识图谱总入口](./knowledge-graph/README.md)
- [能力目录：功能、入口、所有者与来源](./knowledge-graph/capability-catalog.md)
- [项目问题路由](./knowledge-graph/question-routing.md)
- [官方、定制与历史移植边界](./knowledge-graph/provenance.md)
...
- [LLM 请求协议、厂商配置与探针规则](./architecture/llm-request-protocols.md)
- [定制分支与上游同步规则](./architecture/customization-branch-sync.md)
- [章节 Runtime 边界](./architecture/chapter-runtime-boundaries.md)
- [世界上下文 Gateway](./architecture/world-context-gateway.md)
- [项目级视觉资源目录](./architecture/visual-asset-catalog.md)

### Workflows

- [自动导演 Runtime 与恢复边界](./workflows/auto-director-runtime.md)
- [自动导演本书世界准备](./workflows/auto-director-world-setup.md)
- [章节生产链路](./workflows/chapter-production-chain.md)
- [LLM 实况执行与任务可见性](./workflows/llm-live-execution.md)
...
- [角色智能层：思路线](./workflows/character-intelligence-layer.md)
- [角色对话层](./workflows/character-dialogue-layer.md)
- [角色影响提案](./workflows/character-influence-proposals.md)
...
- [分卷规划](./workflows/volume-planning.md)
...
- [任务中心产品职责](./product/task-center-role.md)
